...
tcc_ave6        = fout.createVariable('tcc_ave6','f4',dimensions=['latitude','longitude'])
...
prep_sfc_ave6   = fout.createVariable('prep_sfc_ave6',  'f4',dimensions=['latitude','longitude'])
dswave_ave6   = fout.createVariable('dswave_ave6',  'f4',dimensions=['latitude','longitude'])
dlwave_ave6   = fout.createVariable('dlwave_ave6',  'f4',dimensions=['latitude','longitude'])
uswave_ave6   = fout.createVariable('uswave_ave6',  'f4',dimensions=['latitude','longitude'])
ulwave_ave6   = fout.createVariable('ulwave_ave6',  'f4',dimensions=['latitude','longitude'])
...
cape_180[:]   = var41_area
cin_180[:]    = var42_area
prep_sfc_ave6[:]    = var45_area
dswave_ave6[:]      = var46_area
dlwave_ave6[:]      = var47_area
uswave_ave6[:]      = var48_area
ulwave_ave6[:]      = var49_area
...
v10m.units           = 'm/s'                    
tcc_ave6.description = 'Total Cloud Cover'
tcc_ave6.long_name   = 'Total Cloud Cover'          
tcc_ave6.units       = '%'                    
...
prep_sfc_ave6.description  = 'Total precipitation at surface'
prep_sfc_ave6.long_name    = 'Total precipitation'          
prep_sfc_ave6.units        = 'kg/m^2'                    
dswave_ave6.description    = 'Downward short wave flux' 
dswave_ave6.long_name      = 'Downward short wave flux'
dswave_ave6.units          = 'W/m^2'                   
dlwave_ave6.description    = 'Downward long wave flux'
dlwave_ave6.long_name      = 'Downward long wave flux'
dlwave_ave6.units          = 'W/m^2'                   
uswave_ave6.description    = 'Upward short wave flux'
uswave_ave6.long_name      = 'Upward short wave flux'
uswave_ave6.units          = 'W/m^2'                   
ulwave_ave6.description    = 'Upward long wave flux'
ulwave_ave6.long_name      = 'Upward long wave flux'
ulwave_ave6.units          = 'W/m^2'                   
